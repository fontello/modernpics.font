...
dump:
	rm -f -r ./src/svg/
	mkdir ./src/svg/
	${BIN}/svg-font-dump -c `pwd`/config.yml -f -i ./src/original/ModernPictograms.svg -o ./src/svg/ -d diff.yml
...
font:
	...
	#font_remap.py -c ./config.yml -i ./src/original/modernpics.otf -o ./font/$(FONT_NAME).ttf
